...
def publish(request):
    ...
    if user and request.method == 'POST':
       # try:
            ...
            if contents.startswith("[mp3]") and contents.endswith("[/mp3]"):
            ...
            elif contents.startswith("[video]") and contents.endswith("[/video]"):
                ...
                if temp.split("!!!", 1)[1]:
                    ...
                    raise RuntimeError('视频格式不正确！')
            elif contents.startswith("[bilibili]") and contents.endswith("[/bilibili]"):
                ...
                if temp.split("!!!", 1)[1]:
                    ...
                    raise RuntimeError('视频格式不正确！')
            elif contents.startswith("[markdown]") and contents.endswith("[/markdown]"):
            ...
            result_obj = {}
            print("videofile", videofile, not videofile)
            print("attachmt", attachmt, not attachmt)
            print("videourl", videourl, not videourl)
            print("", )
