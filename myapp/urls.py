...
urlpatterns = [
    ...
    path('like/<int:type>/<str:id>', views.like, name='like'),
    path('dislike/<int:type>/<str:id>', views.dislike, name='dislike'),
    path('post_link/<str:postid>/', views.detail, name='detail'),
